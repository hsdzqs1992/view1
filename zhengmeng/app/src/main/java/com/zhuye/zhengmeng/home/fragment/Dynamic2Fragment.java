...
public class Dynamic2Fragment extends BaseFragment {
                ...
                DreamApi.conditionListNorefresh(CONDITION_LIST_WHAT, token, String.valueOf(page), "0", new MyCallBack() {
                    ...
                    public void onSuccess(int what, Response<String> result) {
                        ...
                        if (datas.size() == 0) {
                            ...
                            multipleDynamicAdapter.addData(datas);
                        }
                    }

                    @Override
                    public void onFail(int what, Response<String> result) {
                        multipleDynamicAdapter.setEmptyView(R.layout.empty, mRecyclerView);
                    }
            ...
            switch (what) {
                case CONDITION_LIST_WHAT:
                    try {
                        ...
                        multipleDynamicAdapter = new MultipleDynamicAdapter(datas, getActivity());


                        //给RecyclerView设置适配器
                        mRecyclerView.setAdapter(multipleDynamicAdapter);
